...
_defineProperty(Calendar, "defaultProps", {
  ...
  renderDay: function renderDay(_ref) {
    ...
    return _react.default.createElement("div", {
      key: day.format(),
      className: (0, _classnames.default)("Calendar-grid-item", day.isSame(selectedDay, "week") && "Calendar-grid-item--week", day.isSame((0, _moment.default)(), "day") && "Calendar-grid-item--current", day.isSame(selectedDay, "day") && "Calendar-grid-item--selected", day.isBefore((0, _moment.default)(), "day") && "prevMonth", classNames),
