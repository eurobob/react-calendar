...
function (_Component) {
  ...
  function Calendar(props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "handleNext", function (type) {
      if (_this.props.onNextMonth) {
        return _this.props.onNextMonth();
      }

      var newDate = _this.state.date.clone().add(1, type);
    ...
    _defineProperty(_assertThisInitialized(_this), "handlePrev", function (type) {
      if (_this.props.onPrevMonth) {
        return _this.props.onPrevMonth();
      }

      var newDate = _this.state.date.clone().subtract(1, type);
...
_defineProperty(Calendar, "defaultProps", {
  ...
  renderHeader: function renderHeader(_ref2) {
    ...
    return _react.default.createElement("div", {
      ...
      onClick: function onClick() {
        return onPrev("months");
      }
    }, "\xAB"), _react.default.createElement("button", {
      ...
      className: "Calendar-month-select",
      onClick: function onClick() {
        return onNext("months");
      }
    }, "\xBB"), _react.default.createElement("button", {
      className: "Calendar-week-select",
      onClick: function onClick() {
        return onNext("weeks");
      }
